...
public class TestArea {
    ...
    public static void CDCalculator() {
        ...
        Scanner myCalculator = new Scanner(System.in);
        float Deposit = myCalculator.nextFloat();
        System.out.print("2. What is the interest rate percentage annually? ");
        float InterestRate = myCalculator.nextFloat() / 100;
        System.out.print("3. How many years will your CD term be? ");
        int Length = myCalculator.nextInt();
        //A = P(1+r/n)(nt)
        //future_value = (Deposit(1+(InterestRate/365)))^(365*Length)
        ...
        float future_value = Math.pow((Deposit*(1+(InterestRate/365))), (365*Length));
